...
<center>
    ![](./assets/ch10/image.png){width=80%}
</center>
...
!!! definition "NPC"
    ...
    3. 判定该问题是一个 NP 问题；
    4. 判定一个已知的 NPC 问题可以**[多项式时间归约🔍](#多项式时间归约){target="_blank"}**为该问题，或判定该问题是 NPH（在下面）问题；
