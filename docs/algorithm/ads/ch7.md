...
<center> ![](./assets/ch7/image.png){ width=50% } </center>
...
<center> ![](./assets/ch7/image-1.png){ width=50% } </center>
...
??? question "Proof"
    === "slice 1"
        ![](./assets/ch7/image-2.png)

    === "slice 2"
        ![](./assets/ch7/image-3.png)
...
??? quesiton "proof"
    === "slice 1"
        ![](./assets/ch7/image-6.png)
    
    === "slice 2"
        ![](./assets/ch7/image-7.png)
