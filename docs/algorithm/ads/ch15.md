...
???+ example "例子"
    ...
    === "题目"
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/1.png" width="60%">
        </div> 
    ...
    === "分析"
        ...
        === "Pass 1"
            ...
            <div style="text-align: center">
                <img src="../assets/ch15/2.png" width="40%">
            </div> 
        ...
        === "Pass 2"
            ...
            <div style="text-align: center">
                <img src="../assets/ch15/3.png" width="40%">
            </div>
        ...
        === "Pass 3"
            ...
            <div style="text-align: center">
                <img src="../assets/ch15/4.png" width="60%">
            </div> 
...
???+ example "例子"
    ...
    === "Pass 1"
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/5.png" width="60%">
        </div> 
    ...
    === "Pass 2"
        ...
        ???+ play "动画演示"
            ...
            <div style="text-align: center">
                <img src="../assets/ch15/6.gif" width="60%">
            </div> 
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/7.png" width="50%">
        </div> 
...
??? example "例子"
    ...
    === "题目"
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/8.png" width="50%">
        </div>     
    ...
    === "分析"
        ...
        === "Pass 1"
            ...
            <div style="text-align: center">
                <img src="../assets/ch15/9.png" width="50%">
            </div>  
        ...
        === "Copy 1"
            ...
            <div style="text-align: center">
                <img src="../assets/ch15/10.png" width="50%">
            </div>  
...
???+ example "例子"
    ...
    === "Split"
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/11.png" width="50%">
        </div>  
    ...
    === "Pass 1"
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/12.png" width="50%">
        </div>  
    ...
    === "Pass 2"
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/13.png" width="50%">
        </div>  

    === "Pass 3"

        <div style="text-align: center">
            <img src="../assets/ch15/14.png" width="50%">
        </div>  

    === "Pass 4"

        <div style="text-align: center">
            <img src="../assets/ch15/15.png" width="50%">
        </div>  

    === "Pass 5"

        <div style="text-align: center">
            <img src="../assets/ch15/16.png" width="50%">
        </div>  

    === "Pass 6"

        <div style="text-align: center">
            <img src="../assets/ch15/17.png" width="50%">
        </div>  

    === "Pass 7"

        <div style="text-align: center">
            <img src="../assets/ch15/18.png" width="50%">
        </div>  
...
???+ example "例子"
    ...
    === "例1"
        ...
        === "题目"
            ...
            <div style="text-align: center">
                <img src="../assets/ch15/24.png" width="50%">
            </div>  
        ...
        === "分析"
            ...
            === "Step 1"
                ...
                <div style="text-align: center">
                    <img src="../assets/ch15/25.png" width="50%">
                </div>  
            ...
            === "Step 2"
                ...
                <div style="text-align: center">
                    <img src="../assets/ch15/26.png" width="50%">
                </div>  
            ...
            === "Step 3"
                ...
                <div style="text-align: center">
                    <img src="../assets/ch15/27.png" width="50%">
                </div>
            ...
            === "Step 4"
                ...
                <div style="text-align: center">
                    <img src="../assets/ch15/28.png" width="50%">
                </div>  
            ...
            === "Step 4.5"
                ...
                <div style="text-align: center">
                    <img src="../assets/ch15/29.png" width="20%">
                </div>  
            ...
            === "Step 5"
                ...
                <div style="text-align: center">
                    <img src="../assets/ch15/30.png" width="50%">
                </div>  
            ...
            === "Step 6~n-1"
                ...
                ???+ play "动画演示"
                    ...
                    <div style="text-align: center">
                        <img src="../assets/ch15/31.gif" width="50%">
                    </div>  
            ...
            === "Step n"
                ...
                <div style="text-align: center">
                    <img src="../assets/ch15/32.png" width="50%">
                </div>  
...
???+ example "例子"
    ...
    === "题目"
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/19.png" width="50%">
        </div>  
    ...
    === "分析"
        ...
        - 首先，我们需要将主存划分为**输入缓存**和**输出缓存**两个部分（此时内部排序应为归并排序）。
            ...
            <div style="text-align: center">
                <img src="../assets/ch15/20.png" width="50%">
            </div>  

        - 然后从两个子序列中分别读出一个记录块到输入缓存中，开始进行内部排序。

            <div style="text-align: center">
                <img src="../assets/ch15/21.png" width="60%">
            </div>  
...
???+ example "例子"
    ...
    === "分析"
        ...
        <div style="text-align: center">
            <img src="../assets/ch15/33.png" width="30%">
        </div> 
